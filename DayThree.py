...
def getunion(lst1, lst2):
    return getdiff(lst1,getdiff(lst1,lst2))


def generatepath(pathstr):
    pt = pathstr.split(',')
    for x in pt:
        if x[:1] == 'U':
            print("Up {} meters".format(x[1:]))
        elif x[:1] == 'D':
            print("Down {} meters".format(x[1:]))
        elif x[:1] == 'R':
            print("Right {} meters".format(x[1:]))
        elif x[:1] == 'L':
            print("LEFT {} meters".format(x[1:]))
        else:
            print("Not ended")
